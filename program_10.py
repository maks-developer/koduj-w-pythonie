...
class Game:
    ...
    def draw_intro(self):
        ...
        story = (
            "Co powiecie na stworzenie gry przygodowej, w której główny bohater - Maks, aby dojść do finału, "
            "pokonuje rozmaite przeszkody i rozwiązuje zagadki? A co, jeśli dodam, że akcja rozgrywa się "
            "w szkole, pozornie najnudniejszym miejscu na świecie? Może wspólnie uda nam się to miejsce "
            "trochę, ekhm... rozruszać? "
            "Rozwiąż wszystkie zagadki, aby zdążyć wyjść ze szkoły na apel odbywający się boisku szkolnym!"
            "\n\n"
